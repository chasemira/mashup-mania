from backend import SONG_OPTIONS_A
from backend import SONG_OPTIONS_B

# TITLE = "Checkers"
# TILES_HORIZONTAL = 4
# TILES_VERTICAL = 4
# TILESIZE = 128
# WINDOWN_WIDTH = TILESIZE * TILES_HORIZONTAL
# WINDOW_HEIGHT = TILESIZE * TILES_VERTICAL
# # ------------------------
# WINDOW_OFFSET = 100
# MAP_CHOICES = ["r_", "b_", "bo", "bx"]
# ------------------------
...
ALBUM_A = "player_a.jpg"
ALBUM_B = "player_b.jpg"
NEUTRAL = "neutral.png"
